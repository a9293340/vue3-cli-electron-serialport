	...
	pluginOptions: {
		...
		electronBuilder: {
			...
			builderOptions: {
				...
				// Windows 相關設定
				win: {
					icon: 'public/axn74-ew7lw-001.ico', // 安裝檔圖示
					target: [
						{
							target: 'nsis', // 檔案類型
				...
				nsis: {
					...
					installerIcon: 'public/axn74-ew7lw-001.ico', // 安裝圖示
					uninstallerIcon: 'public/axn74-ew7lw-001.ico', // 卸載圖示
					installerHeaderIcon: 'public/axn74-ew7lw-001.ico', // 安裝頂部圖示
